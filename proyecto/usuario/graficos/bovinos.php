...
// ------------------------------- Años  -------------------------------
$anios_result = $conexion->query("SELECT DISTINCT YEAR(fecha) as anio FROM inseminacion_bovina ORDER BY anio DESC");
if ($anios_result) {
...
if (!empty($anio_seleccionado) && !empty($mes_seleccionado)) {
    $tabla_parto = 'inseminacion_bovina';
    $alias_tabla = 'ib';
    $campos = "ib.id_inseminacion, g.nombre AS nombre_animal, ib.fecha, ib.padre, ib.est_parto, ib.observaciones";
    $join_condicion = "g.ID_animal = ib.id_animal";
                        ...
                        <div class="card card-body">
                            <div class="horz-grid">
                                <div class="row show-grid">
                                    <iframe width="935" height="702" src="https://lookerstudio.google.com/embed/reporting/4b37a7a3-9562-414c-b1d5-83aeb2ad949f/page/7RwVE" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>
                                </div>
                            </div>
                        </div>                        
                    </div>
