...
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=datos_generales_porcinos';">
...
<!-- Rectángulo 2 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=inseminacion_porcina';">
        <h5>Inseminacion</h5>
...
<!-- Rectángulo 3 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=parto_porcino';">
        <h5>Partos</h5>
