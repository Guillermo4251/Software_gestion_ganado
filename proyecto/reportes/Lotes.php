...
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=datos_generales_lotes';">
        ...
        <p>Descripción de la opción 1.</p>
              ...
              <!-- Rectángulo 2 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=produccion_lotes';">
        <h5>Produccion De los Lotes</h5>
        <p>Descripción de la opción 1.</p>
    </div>
</div>
