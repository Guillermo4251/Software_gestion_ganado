...
<body>
    ...
    <div class="main-content">
        <main>
            <div class="container">
                <h2 class="text-center mb-5">Generar Informe</h2>
  ...
  <div class="cards-container">
                    ...
                    <div class="card-item">
                        <div class="card">
                            <img src="images/cow.jpg" class="card-img-top" alt="Vaca">
                            <div class="card-body">
                                <h5 class="card-title">Bovinos</h5>
                                <p class="card-text">Generar Reportes de Bovinos</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Bovinos.php" class="btn btn-primary">Ver más</a>
                            </div>
                        </div>
                    </div>
                    <!-- Tarjeta 2 -->
                    <div class="card-item">
                        <div class="card">
                            <img src="images/pigstep.jpg" class="card-img-top" alt="Gato">
                            <div class="card-body">
                                <h5 class="card-title">Porcinos</h5>
                                <p class="card-text">Descripción breve de la mascota 2.</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Porcinos.php" class="btn btn-primary">Ver más</a>
                            </div>
                        </div>
                    </div>
                    <!-- Tarjeta 3 -->
                    <div class="card-item">
                        <div class="card">
                            <img src="images/oja.jpg" class="card-img-top" alt="Perro">
                            <div class="card-body">
                                <h5 class="card-title">Ovinos</h5>
                                <p class="card-text">Descripción breve de la mascota 3.</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Ovinos.php" class="btn btn-primary">Ver más</a>
                            </div>
                        </div>
                    </div>
                    <!-- Tarjeta 4 -->
                    <div class="card-item">
                        <div class="card">
                            <img src="images/carbalho.jpg" class="card-img-top" alt="Pájaro">
                            <div class="card-body">
                                <h5 class="card-title">Equinos</h5>
                                <p class="card-text">Descripción breve de la mascota 4.</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Equinos.php" class="btn btn-primary">Ver más</a>
                            </div>
                        </div>
                    </div>
                    <!-- Tarjeta 5 -->
                    <div class="card-item">
                        <div class="card">
                            <img src="images/cock.jpg" class="card-img-top" alt="Pez">
                            <div class="card-body">
                                <h5 class="card-title">Lotes</h5>
                                <p class="card-text">Descripción breve de la mascota 5.</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Lotes.php" class="btn btn-primary">Ver más</a>
                            </div>
                        </div>
                    </div>
                    <!-- Tarjeta 6 -->
                    <div class="card-item">
                        <div class="card">
                            <img src="images/nacho.jpg" class="card-img-top" alt="Hámster">
                            <div class="card-body">
                                <h5 class="card-title">Produccion</h5>
                                <p class="card-text">Descripción breve de la mascota 6.</p>
                                <a href="https://nukatech.cl/citt/usuario/reportes/Roedores.php" class="btn btn-primary">Ver más</a>
                            </div>
            </div>
        </main>
    </div>
