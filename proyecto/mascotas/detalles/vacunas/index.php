...
$sql = "SELECT * FROM registro_vacuna_mascota where id_animal = $id_mascota";
...
?>
    ...
    <i class="fas fa-arrow-left"></i>
            ...
            function goBackWithPost() {
                ...
                hiddenField.name = "id_mascota"; // Nombre del campo
                hiddenField.value = "<?php echo htmlspecialchars($id_mascota); ?>"; // Valor del campo
                    ...
                    <div class="horz-grid">
                        ...
                        <form method="post" action="añadir.php">
                            <div class="row show-grid">
                                ...
                                <div class="">
                                    <input type="hidden" id="id_animal" name="id_animal" value="<?php echo $id_mascota; ?>">
                                </div>
