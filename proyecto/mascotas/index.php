...
$sql = "SELECT * FROM Mascotas ORDER BY especie DESC";
                                                ...
                                                <td data-label="cantidad"><?php echo $row['especie']; ?></td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                            data-bs-target="#confirm-delete-<?php echo $row['id_mascota']; ?>">
                                                            Eliminar
                                                        </button>
                                                        <div class="modal fade" id="confirm-delete-<?php echo $row['id_mascota']; ?>" tabindex="-1" role="dialog"
