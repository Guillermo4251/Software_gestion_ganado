...
$sql = "SELECT * FROM inseminacion_bovina where id_animal = $id_animal";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                            data-bs-target="#confirm-delete-<?php echo $row['id_inseminacion']; ?>">
                                                            Eliminar
                                                        </button>
                                                        <div class="modal fade" id="confirm-delete-<?php echo $row['id_inseminacion']; ?>" tabindex="-1" role="dialog"
