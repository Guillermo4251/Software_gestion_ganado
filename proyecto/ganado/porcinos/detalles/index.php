...
// Consultas SQL para obtener datos del animal
...
$animal_data = mysqli_fetch_array($query);

$sql_monta = "SELECT * FROM monta_porcino WHERE id_cerdo = $id_animal";
$query_monta = mysqli_query($conexion, $sql_monta);

$sql_parto = "SELECT * FROM parto_porcino WHERE id_cerdo = $id_animal";
$query_parto = mysqli_query($conexion, $sql_parto);

$sql_destete = "SELECT * FROM destete WHERE id_madre = $id_animal";
$query_destete = mysqli_query($conexion, $sql_destete);

$sql_vacunas = "SELECT * FROM registro_vacuna WHERE id_animal = $id_animal";
$query_vacunas = mysqli_query($conexion, $sql_vacunas);

$sql_clinica = "SELECT * FROM ficha_clinica WHERE id_animal = $id_animal";
$query_clinica = mysqli_query($conexion, $sql_clinica);
?>
        ...
        <main>
            ...
            <section class="recent">
                <div class="activity-grid">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="button-container">
                                            <button type="button" class="btn btn-success position-relative"
                                                ...
                                                style="bottom: 0; right: 0; position: absolute; margin-top: 5px;">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                        </section>
                                ...
                                <div class="modal-body">
                                    <form action="actualizar_animal.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="numero_crotal"
                                                name="numero_crotal"
                                                value="<?php echo htmlspecialchars($animal_data['numero_crotal']); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="diio" class="form-label">DIIO</label>
                                            <input type="text" class="form-control" id="diio" name="diio"
                                                value="<?php echo htmlspecialchars($animal_data['diio']); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="nombre" class="form-label">Nombre</label>
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                value="<?php echo htmlspecialchars($animal_data['nombre']); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="peso" class="form-label">Peso</label>
                                            <input type="number" class="form-control" id="peso" name="peso"
                                                value="<?php echo htmlspecialchars($animal_data['peso']); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento</label>
                                            <input type="date" class="form-control" id="fecha_nacimiento"
                                                name="fecha_nacimiento"
                                                value="<?php echo htmlspecialchars($animal_data['fecha_nacimiento']); ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="ID_padre" name="ID_padre"
                                                value="<?php echo htmlspecialchars($animal_data['ID_padre']); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="ID_madre" class="form-label">ID Madre</label>
                                            <input type="text" class="form-control" id="ID_madre" name="ID_madre"
                                                value="<?php echo htmlspecialchars($animal_data['ID_madre']); ?>">
                                        </div>
                    ...
                    <!-- Sección Monta -->
                    <div class="horz-grid">
                        <h4 class="grid-example-basic">Monta</h4>
                        <section class="recent">
                            <div class="activity-grid">
                                <div class="activity-card">
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($query3)): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $row['raza_verraco']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['est_parto']; ?>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                        ...
                        <div class="grid-hor d-flex justify-content-end" style="margin-top: 5px;">
                            <form action="monta/index.php" method="post">
                                <input type="hidden" name="ID_animal" value="<?php echo $id_animal; ?>">
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($query4)): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $row['lechones_vivos']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['lechones_muertos']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['peso_promedio']; ?>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                    ...
                    <!-- Sección Destete -->
                    <div class="horz-grid">
                        <h4 class="grid-example-basic">Destete</h4>
                        <section class="recent">
                            <div class="activity-grid">
                                <div class="activity-card">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Peso promedio</th>
                                                    <th>Días al destete</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($query_destete)): ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $row['fecha']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['n_cerdos']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['peso_promedio']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['dias_al_destete']; ?>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                        ...
                        <div class="grid-hor d-flex justify-content-end" style="margin-top: 5px;">
                            <form action="destete/index.php" method="post">
                                <input type="hidden" name="ID_animal" value="<?php echo $id_animal; ?>">
                                <button type="submit" class="btn btn-primary">VER</button>
                            </form>
                        </div>
