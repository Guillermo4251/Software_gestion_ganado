...
$sql = "SELECT * FROM registro_vacuna where id_animal = $id_animal";
                        ...
                        <form method="post" action="añadir.php">
                            <div class="row show-grid">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="proxima"  class="form-control1"></input>
                                </div>
                        ...
                        <section class="recent">
                            ...
                            ?>
                                                <tr>
                                                    ...
                                                    <td data-label="Proxima dosis"><?php echo $row['proxima']; ?></td>
