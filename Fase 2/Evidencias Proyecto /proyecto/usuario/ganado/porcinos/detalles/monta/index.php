...
$sql = "SELECT * FROM monta_porcino where id_cerdo = $id_animal";
            ...
            <section class="recent">
                <div class="activity-grid">
                    <div class="horz-grid">
                        ...
                        <form method="post" action="añadir_monta.php">
                            <div class="row show-grid">
                                ...
                                <div class="col-md-4">
                                    <label for="diagnostico">Raza del verraco</label>
                                    <input type="Text" name="raza"  class="form-control1"></input>
                                </div>
                                
                                <div class="col-md-4">
                                    <label for="diagnostico">Estimacion del parto</label>
                    ...
                    <div class="horz-grid">
                        ...
                        <section class="recent">
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th>ID monta</th>
                                                    <th>Fecha</th>
                                                    <th>Raza del verraco</th>
                                                    <th>estimacion del parto</th>
                                                    <th> </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                            ...
                            ?>
                                                <tr>
                                                    <td data-label="ID de monta"><?php echo $row['id_monta']; ?></td>
                                                    <td data-label="Fecha"><?php echo $row['fecha']; ?></td>
                                                    <td data-label="raza del verraco"><?php echo $row['raza_verraco']; ?></td>
                                                    <td data-label="estimacion del parto"><?php echo $row['est_parto']; ?></td>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form action="eliminar.php" method="post">
                                                                            <input type="hidden" name="id_monta" value="<?php echo $row['id_monta']; ?>">
