...
$sql = "SELECT * FROM animales_trabajo WHERE id_animal = $id_animal";
    ...
    form.submit();
            ...
            <section class="recent">
                <div class="activity-grid">
                    <div class="horz-grid">
                        <div class="grid-hor">
                            <h4 class="grid-example-basic">Detalles de animal</h4>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <select name="subtipo" class="form-control1" required>
                                        ...
                                        <option value="caballo" <?php if ($animal_data['subtipo'] === 'caballo') echo 'selected'; ?>>caballo</option>
                                        <option value="burro" <?php if ($animal_data['subtipo'] === 'burro') echo 'selected'; ?>>burro</option>
                                    </select>
                                        </div>
