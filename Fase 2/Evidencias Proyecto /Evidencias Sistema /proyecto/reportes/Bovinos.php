...
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=datos_generales';">
        <h5>Datos generales Bovinos</h5>
        <p>Descripción de la opción 1.</p>
    </div>
</div>
<!-- Rectángulo 2 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=inseminacion';">
        <h5>Inseminacion Bovina</h5>
        <p>Descripción de la opción 2.</p>
    </div>
</div>
<!-- Rectángulo 3 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=parto';">
        <h5>Partos Bovinos</h5>
        <p>Descripción de la opción 3.</p>
    </div>
</div>
<!-- Rectángulo 4 -->
<div class="col-12 col-sm-6 col-lg-4">
    <div class="clickable-card" onclick="window.location.href='generar_info.php?opcion=produccion_bovina';">
        <h5>Produccion Bovina</h5>
        <p>Descripción de la opción 3.</p>
    </div>
</div>
