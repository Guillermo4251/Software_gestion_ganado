...
$sql = "SELECT * FROM ganado where tipo_animal = 'vacuno' ORDER BY ID_animal DESC";$query = mysqli_query($conexion, $sql);
// Comprobar conexión
if (!$conexion) {
                    ...
                    <!--insertar animales-->
                        <form method="post" action="insertar_vacuno.php" enctype="multipart/form-data">
                            <div class="row show-grid">
                                ...
                                <div class="">
                                    <input type="hidden" id="tipo_animal" name="tipo_animal" value="vacuno">
                                </div>
                                ...
                                <div class="col-md-4 grid_box1">
                                    <label>Crotal</label>
                                    <input type="text" name="numero_crotal"  class="form-control1">
                                </div>
                                
                                <div class="col-md-3 grid_box1">
                                    <label>DIIO</label>
                                    <input type="number" name="DIIO" id="peso" class="form-control1">
                            </div>
                                ...
                                <div class="col-md-6 grid_box1">
                                    <label>Padre</label>
                                    <input type="text" name="padre" class="form-control1" >
                                </div>
                                
                                <div class="col-md-6 grid_box1">
                                    <label>Madre</label>
                                    <input type="text" name="madre" class="form-control1" >
                                </div>       
                            </div>
                            <div class="d-grid gap-2 col-12 col-md-6 mx-auto btn-guardar">
                                                    ...
                                                    <td>
                                                        <form action="detalles/index.php" method="POST">
                                                            ...
                                                            <div class="d-grid gap-2 col-12 col-md-6 mx-auto">
                                                                <button type="submit" class="btn btn-primary btn-block">Detalles</button>
                                                            </div>
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <div class="d-grid gap-2 col-12 col-md-6 mx-auto">
                                                            <button type="button" class="btn btn-danger btn-block" data-bs-toggle="modal" data-bs-target="#confirm-delete-<?php echo $row['ID_animal']; ?>">
                                                                Eliminar
                                                            </button>
                                                        </div>
