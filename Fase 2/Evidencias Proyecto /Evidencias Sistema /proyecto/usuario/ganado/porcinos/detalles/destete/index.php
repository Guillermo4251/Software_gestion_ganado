...
$sql = "SELECT * FROM destete where id_madre = $id_animal";
                ...
                <div class="activity-grid">
                    <div class="horz-grid">
                        ...
                        <form method="post" action="añadir.php">
                            <div class="row show-grid">
                                ...
                                <div class="col-md-4">
                                    <label for="diagnostico">Numero de cerdos</label>
                                    <input type="number" name="n_cerdos"  class="form-control1"></input>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label for="diagnostico">Dias al destete</label>
                                    <input type="number" name="dias_destete"  class="form-control1"></input>
                                </div>
                    ...
                    <div class="horz-grid">
                        ...
                        <section class="recent">
                            ...
                            ?>
                                                <tr>
                                                    <td data-label="ID de monta"><?php echo $row['fecha']; ?></td>
                                                    <td data-label="Fecha"><?php echo $row['n_cerdos']; ?></td>
                                                    <td data-label="raza del verraco"><?php echo $row['peso_promedio']; ?></td>
                                                    <td data-label="estimacion del parto"><?php echo $row['dias_al_destete']; ?></td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                            data-bs-target="#confirm-delete-<?php echo $row['id_destete']; ?>">
                                                            Eliminar
                                                        </button>
                                                        <div class="modal fade" id="confirm-delete-<?php echo $row['id_destete']; ?>" tabindex="-1" role="dialog"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form action="eliminar.php" method="post">
                                                                            <input type="hidden" name="id_destete" value="<?php echo $row['id_destete']; ?>">
