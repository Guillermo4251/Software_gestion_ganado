...
$sql = "SELECT * FROM mortalidad_lote where lote = $id_lote";
                        ...
                        <form method="post" action="añadir.php">
                            <div class="row show-grid">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="number" name="cantidad"  class="form-control1"></input>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                            data-bs-target="#confirm-delete-<?php echo $row['id_mortalidad']; ?>">
                                                            Eliminar
                                                        </button>
                                                        <div class="modal fade" id="confirm-delete-<?php echo $row['id_mortalidad']; ?>" tabindex="-1" role="dialog"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form action="eliminar.php" method="post">
                                                                            <input type="hidden" name="id_mortalidad" value="<?php echo $row['id_mortalidad']; ?>">
