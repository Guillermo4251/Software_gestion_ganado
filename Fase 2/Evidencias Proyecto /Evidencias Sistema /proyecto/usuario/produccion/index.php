...
$sql = "SELECT * FROM produccion ORDER BY id DESC LIMIT 5";
                    ...
                    <!--insertar animales-->
                        <form method="post" action="insertar.php">
                            <div class="row show-grid">                                
                                ...
                                <div class="col-md-3 grid_box1">
                                    <label>Tipo</label>
                                    <select name="tipo" class="form-control1" required>
                                ...
                                <div class="col-md-3 grid_box1">
                                    ...
                                    <input type="number" name="produccion"  class="form-control1"></input>
                                </div>
                                
                                <div class="col-md-3 grid_box1">
                                    <label>Recolector</label>
                                    <input type="text" name="recolector"  class="form-control1"></input>
                                </div>
                                
                                <div class="col-md-12 grid_box1">
                                    <label>Observacion</label>
                                    <input type="text" name="observacion" maxlength="50" class="form-control2"></input>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <td data-label="Fecha"><?php echo $row['fecha']; ?></td>
                                                    <td data-label="Produccion"><?php echo $row['produccion']; ?></td>
                                                    <td data-label="Recolector"><?php echo $row['recolector']; ?></td>
                                                    <td data-label="Observacion"><?php echo $row['observacion']; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-block btn-custom" data-bs-toggle="modal" data-bs-target="#confirm-delete-<?php echo $row['id']; ?>">
                                                                Eliminar
                                                            </button>
                                                            
                                                            <div class="modal fade"
                                                            id="confirm-delete-<?php echo $row['id']; ?>"
